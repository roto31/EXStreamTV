...
WIKI_PAGE_SOURCES: Final[dict[str, str]] = {
    ...
    "Pattern-Refactor-Sources": "docs/architecture/PATTERN_REFACTOR_SOURCES.md",
    "ADR-Channel-Manager-Database": "docs/architecture/ADR-channel-manager-database-sessions.md",
    "EXStreamTV-UI-Architecture": "docs/EXStreamTV-UI-Architecture.md",
