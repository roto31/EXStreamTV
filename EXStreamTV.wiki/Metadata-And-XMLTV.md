...
No dashes, no colons, literal `+0000` offset (not `%z` which may produce empty string on naive datetimes). See [`docs/LESSONS_LEARNED.md`](Lessons-Learned) entries LL-007 through LL-009.
