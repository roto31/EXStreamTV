...
- **Canonical diagrams:** [Architecture Diagrams](Architecture-Diagrams) — 19 Mermaid diagrams (system overview, schedule history memento, FFmpeg constants layer, async lock pattern, six-layer AI/coding safety, etc.).
...
- [Observability](Observability) — Full metrics reference.
- [Feature Flags](Feature-Flags) — Config toggles.
